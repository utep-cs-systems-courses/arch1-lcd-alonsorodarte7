                                           ...
                                           It will turn blue when it moves to the left */
{
  ...
  for(u_char r = 30; r<40; r++){        /* This draws the main box */
	...
	drawPixel(s,r,COLOR_BLUE);
      }
      else{                             /* else it was already inbounds */
	drawPixel(y+c,r,COLOR_BLUE);
      }
    }
  }
  ...
  y-=2;                                 /* move y to the left 5 pixels */
}
